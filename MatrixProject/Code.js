...
var ASM_CONSTS = {
  ...
  var TTY={ttys:[],init:function () {
        ...
        /*      for(let i = 0; i < dataB.length; i++){
              ...
              result = dataB[k];  // returns null on cancel
              k++;
//              console.log(result);
              if (result !== null) {
                result += '\n';
          ...
          if (val === null || val === 10) {
            arrRES[countR] = UTF8ArrayToString(tty.output, 0);
            if(arrRES.length == np3){
              fillResArr();
            }
 //         console.log(arrRES[countR]);
            countR++;
            tty.output = [];
          } else {
            if (val != 0) {
